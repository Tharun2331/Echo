    ...
    <Sidebar className="group!" collapsible="icon">
              ...
              <OrganizationSwitcher
               ...
               appearance={{
                elements:{
                  ...
                  organizationSwitcherTriggerIcon: "group-data-[collapsible=icon]:hidden! ml-auto! text-siderbar-foreground!"
                }
               }}
               />
            </SidebarMenuButton>
      ...
      <SidebarContent>
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {customersSupportItems.map((item)=> (
